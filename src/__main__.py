...
def startProcess(runningBV, consoleTextBox, incallPath, intallPath, arrestsPath, dateStart, dateEnd, ytd, cw, boroList):
    ...
    statProcess = multiprocessing.Process(target=run.process, args=(templatePath, outputDirectory, reportPath, presentationPath, incallPath, intallPath, arrestsPath, dateStart, dateEnd, ytd, cw, boroList, queue))
